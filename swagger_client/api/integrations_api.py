...
class IntegrationsApi(object):
    ...
    def crypto_get_orderbooks(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.crypto_get_orderbooks(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param OrderbookRequest body: Exchange, trading pair and date rage for data (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.crypto_get_orderbooks_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.crypto_get_orderbooks_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def crypto_get_orderbooks_with_http_info(self, body, **kwargs):  # noqa: E501
        """Returns the current state of the orderbook.  # noqa: E501

        This endpoint returns the current state of the ordebook with a limit set by you. The maximun orderbook depth is 25.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.crypto_get_orderbooks_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `crypto_get_orderbooks`")  # noqa: E501
